...
class SMPL(_SMPL):
    ...
    def get_ntu_joints(self, vertices):
        ...
        if self.J_regressor_ntu is not None:
            ...
            # NTU 1: Mid spine - between pelvis and spine_20
            ntu_joints[..., 1, :] = (pelvis + ntu_joints[..., 20, :]) / 2.0

            # NTU 2: Neck - mid-shoulder
            ntu_joints[..., 2, :] = neck
            ...
            ntu_joints[..., 22, :] = ntu_joints[..., 7, :]  # same as left hand

            # NTU 23-24: Right hand tips (tip of right hand, right thumb)
            ntu_joints[..., 23, :] = ntu_joints[..., 11, :]  # same as right hand
            ntu_joints[..., 24, :] = ntu_joints[..., 11, :]  # same as right hand
