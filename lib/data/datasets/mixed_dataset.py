...
from .videos import Human36M, ThreeDPW, MPII3D, InstaVariety, HuMManDataset
...
class DataFactory(torch.utils.data.Dataset):
    def __init__(self, cfg, train_stage='syn'):
        ...
        if train_stage == 'stage1':
            ...
            # self.datasets = [Human36M(cfg)]
            # self.dataset_names = ['Human36M']
            ...
            #self.dataset_names = ['AMASS', 'Human36M', 'MPII3D', 'Insta']
            self.dataset_names = ['3DPW','AMASS', 'Human36M', 'MPII3D', 'Insta', 'HuMMan'] #, 'Freeman']
            #self.dataset_names = ['3DPW','Human36M', 'MPII3D', 'Insta']
            #self.dataset_names = ['Human36M']
            
            if len(cfg.DATASET.RATIO) == 8: # Use BEDLAM
