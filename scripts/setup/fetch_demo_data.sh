...
# Checkpoints
mkdir -p checkpoints
gdown "https://drive.google.com/uc?id=1i7kt9RlCCCNEW2aYaDWVr-G778JkLNcB&export=download&confirm=t" -O 'checkpoints/movid_vit_w_3dpw.pth.tar'
gdown "https://drive.google.com/uc?id=19qkI-a6xuwob9_RFNSPWf1yWErwVVlks&export=download&confirm=t" -O 'checkpoints/movid_vit_bedlam_w_3dpw.pth.tar'
