...
MoViD has been tested on Ubuntu 20.04 and 22.04 with Python 3.9. The setup below uses the current MoViD repository layout and its bundled third-party dependencies.
...
conda create -n movid python=3.9
...
# Install MoViD Python dependencies
